...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gkg-o78.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gkg-o78.containers.anotherwebservice.com/
...
```
git clone git@github.com:joeltejeda/container-gkg-o78.git
cd container-gkg-o78
```
...
```
docker attach container-gkg-o78
```
